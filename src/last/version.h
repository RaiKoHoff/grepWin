...
#define FILEVER         1, 9, 2, 608
#define PRODUCTVER      1, 9, 2, 608
#define STRFILEVER      "1.9.2.608\0"
#define STRPRODUCTVER   "1.9.2.608\0"

#define GREPWIN_VERMAJOR     1
#define GREPWIN_VERMINOR     9
#define GREPWIN_VERMICRO     2
#define GREPWIN_VERBUILD     608
#define GREPWIN_VERDATE      "2020-03-27"
